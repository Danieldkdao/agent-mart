...
const MessageHeader = ({ className, ...props }: React.ComponentProps<"div">) => {
  return (
    <div
      ...
      className={cn(
        "flex max-w-full min-w-0 items-center px-3 text-base font-medium text-muted-foreground group-has-data-[variant=ghost]/message:px-0",
        className
      )}
      {...props}
    />
...
const MessageFooter = ({ className, ...props }: React.ComponentProps<"div">) => {
  return (
    <div
      ...
      className={cn(
        "flex max-w-full min-w-0 items-center px-3 text-base font-medium text-muted-foreground group-has-data-[variant=ghost]/message:px-0 group-data-[align=end]/message:justify-end",
        className
      )}
      {...props}
    />
